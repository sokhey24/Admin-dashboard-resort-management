...
import { Badge } from "@/y/base/badges/badges";
import { Checkbox } from "@/y/base/checkbox/checkbox";
import { Dropdown } from "@/y/base/dropdown/dropdown";
import { Tooltip, TooltipTrigger } from "@/y/base/tooltip/tooltip";
                ...
                <div className="flex items-center gap-2">
                    ...
                    {badge ? (
                        isValidElement(badge) ? (
                            ...
                            <Badge color="gray" size="sm" type="modern">{badge}</Badge>
                        )
                    ) : null}
                </div>
...
const TableHeader = ({ columns, children, bordered = true, className, size: sizeProp, ...props }) => {
    const context = useContext(TableContext);
...
const TableCell = ({ className, children, size: sizeProp, ...props }) => {
    const context = useContext(TableContext);
    const { selectionBehavior } = useTableOptions();
    const size = sizeProp ?? context.size;
