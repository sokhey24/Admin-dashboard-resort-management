...
import { Dot } from "@/y/foundations/dot-icon";
...
export const Badge = ({ type = "pill-color", size = "md", color = "gray", children, className }) => {
...
export const BadgeWithDot = ({ size = "md", color = "gray", type = "pill-color", className, children }) => {
...
export const BadgeWithIcon = ({ size = "md", color = "gray", type = "pill-color", iconLeading: IconLeading, iconTrailing: IconTrailing, children, className }) => {
    const colors = withBadgeTypes[type];
    const icon = IconLeading ? "leading" : "trailing";
    const pillSizes = {
        sm: { trailing: "gap-0.5 py-0.5 pl-2 pr-1.5 text-xs font-medium", leading: "gap-0.5 py-0.5 pr-2 pl-1.5 text-xs font-medium" },
        md: { trailing: "gap-1 py-0.5 pl-2.5 pr-2 text-sm font-medium", leading: "gap-1 py-0.5 pr-2.5 pl-2 text-sm font-medium" },
        lg: { trailing: "gap-1 py-1 pl-3 pr-2.5 text-sm font-medium", leading: "gap-1 py-1 pr-3 pl-2.5 text-sm font-medium" },
    };
    const badgeSizes = {
        sm: { trailing: "gap-0.5 py-0.5 pl-2 pr-1.5 text-xs font-medium", leading: "gap-0.5 py-0.5 pr-2 pl-1.5 text-xs font-medium" },
        md: { trailing: "gap-1 py-0.5 pl-2 pr-1.5 text-sm font-medium", leading: "gap-1 py-0.5 pr-2 pl-1.5 text-sm font-medium" },
        lg: { trailing: "gap-1 py-1 pl-2.5 pr-2 text-sm font-medium rounded-lg", leading: "gap-1 py-1 pr-2.5 pl-2 text-sm font-medium rounded-lg" },
    };
    const sizes = {
        [badgeTypes.pillColor]: pillSizes,
        [badgeTypes.badgeColor]: badgeSizes,
...
export const BadgeWithFlag = ({ size = "md", color = "gray", flag = "AU", type = "pill-color", children }) => {
    const colors = withPillTypes[type];
    const pillSizes = {
...
export const BadgeWithImage = ({ size = "md", color = "gray", type = "pill-color", imgSrc, children }) => {
    const colors = withPillTypes[type];
    const pillSizes = {
        sm: "gap-1 py-0.5 pl-0.75 pr-2 text-xs font-medium",
        md: "gap-1.5 py-0.5 pl-1 pr-2.5 text-sm font-medium",
...
export const BadgeWithButton = ({ size = "md", color = "gray", type = "pill-color", icon: Icon = CloseX, buttonLabel, children, onButtonClick }) => {
    const colors = withPillTypes[type];
    const pillSizes = {
...
export const BadgeIcon = ({ size = "md", color = "gray", type = "pill-color", icon: Icon }) => {
    const colors = withPillTypes[type];
    const pillSizes = { sm: "p-1.25", md: "p-1.5", lg: "p-2" };
    const badgeSizes = { sm: "p-1.25", md: "p-1.5", lg: "p-2 rounded-lg" };
    const sizes = {
        [badgeTypes.pillColor]: pillSizes,
        [badgeTypes.badgeColor]: badgeSizes,
        [badgeTypes.badgeModern]: badgeSizes,
