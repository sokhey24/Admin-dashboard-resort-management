...
import { Tooltip as AriaTooltip, TooltipTrigger as AriaTooltipTrigger } from "@/y/base/tooltip/tooltip";
...
export const AvatarAddButton = ({ size, className, title = "Add user", ...props }) => (
